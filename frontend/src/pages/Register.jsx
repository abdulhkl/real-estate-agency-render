...
function Register() {
    ...
    const { name, title, phone, email, password, password2, photo, admin, skey } = formData
        ...
        <>
            <section className='form'>
                <section className='pt-12 pb-8'>
                    <h2 className='text-3xl items-center flex'><FaUser className='mr-2' />Create your Account</h2>
