                    ...
                    <div className="p-10 mt-2 md:w-1/2">
                        ...
                        <ul className='desc-list'>
                            ...
                            <li className='flex justify-center'>
                                <span className='m-2 w-20'><Link to='' className='btn btn-reverse btn-sm' onClick={() => { onDeleteProperty(property._id) }}>DELETE</Link></span>
                                <span className='m-2 w-20'><Link to={`/property/update/${property._id}`} state={property} className='btn btn-reverse btn-sm'>
                                    EDIT
                                </Link></span>
                            </li>
                        </ul>
